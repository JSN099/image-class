...
import com.example.my.ml.BirdsModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //to download image when long press on Image view
    ...
    private val requestPermissionLauncher = registerForActivityResult(ActivityResultContracts.RequestPermission()){
        ...
        if (isGranted){
            AlertDialog.Builder(this).setTitle("Download Image?")
                .setMessage("Do you want to downoad this image to your device?")
            ...
            Toast.makeText(this, "Please allow permission todownload image", Toast.LENGTH_LONG).show()
        }


    }

    //fun that takes bitmap and stores to user's device
